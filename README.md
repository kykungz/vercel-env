...
@kykungz/vercel-env/1.0.0 darwin-x64 node-v10.20.1
...
_See code: [src/commands/preview.ts](https://github.com/kykungz/vercel-env/blob/v1.0.0/src/commands/preview.ts)_
...
_See code: [src/commands/production.ts](https://github.com/kykungz/vercel-env/blob/v1.0.0/src/commands/production.ts)_
<!-- commandsstop -->
